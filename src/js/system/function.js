        ...
        if (
            ...
            var edit = layer.open({
                ...
                content: '<div class="modal-content radius">' +
                    ...
                    dataValue.functionId +
                    "</div>" +
                    '<div style="text-align: center"></div>' +
                    '<form role="form">' +
                    '<div class="form name">' +
                    '<label for="name">功能名字：</label>' +
                    '<input type="text" class="input-text radius" id="functionEditName" value=' +
                    dataValue.functionName +
                    ' placeholder="请输入名称" required="required" >' +
                    "</div>" +
                    '<div class="form flag">' +
                    '<label for="functionFlag">功能标记：</label>' +
                    '<input type="text" id="functionEditFlag" value=' +
                    dataValue.functionFlag +
                    ' class="input-text radius" placeholder="请填写功能标记" required="required" >' +
                    "</div>" +
                    "</form>" +
                    "</div>",
                                ...
                                value1.childs.forEach(function (
                                    ...
                                    if (value2.functionInfoBeans && value2.functionInfoBeans.length > 0) {
                                        ...
                                        if (
                                            ...
                                            td3 +=
                                                '<tr><td  style="height: 30px; border-bottom: none;">没有功能</td><td pid="' +
                                                value2.id +
                                                '" class="td-manage" style="height: 30px; border-bottom: none;"><a title="添加" href="javascript:;" class="ml-3" style="text-decoration:none"><i class="Hui-iconfont">&#xe600;</i></a></td></tr>';
                                        } else {
                                            td3 +=
                                                '<tr><td style="height: 30px;">没有功能</td><td class="td-manage"  pid="' +
                                                value2.id +
                                                '"  style="height: 30px;"><a   title="添加" href="javascript:;" class="ml-3" style="text-decoration:none"><i class="Hui-iconfont">&#xe600;</i></a></td></tr>';
                                        }
                                    }
